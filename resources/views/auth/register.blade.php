                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="register_as_librarian">
                                    <label class="form-check-label" for="register_as_librarian">
...
<script>
    document.getElementById('register_as_librarian').addEventListener('change', function () {
        ...
        codeSection.style.display = this.checked ? 'flex' : 'none';
    });
</script>
@endsection
